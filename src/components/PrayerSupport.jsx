  ...
  return (
    <div className="">
      <div className="m-15 grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {POSTprayer.map((post) => ( 
          <div key={post.id} className="flex flex-col justify-center items-center bg-white/10 backdrop-blur-md border-white/30 rounded-3xl shadow-2xl p-6 m-5 max-w-md w-full cursor-default ">
