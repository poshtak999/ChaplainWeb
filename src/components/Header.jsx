  ...
  return (
    <header className="relative mb-10 pt-5">
      <div className="flex justify-center items-center relative">
        ...
        {/* Block Registratio and Login */}
        {/* 
        <div className="absolute right-0 m-5">
          <button className="text-xl text-amber-50 border-3 p-5 rounded-3xl m-5">
            Вхід
          </button>
          <button className="text-xl text-amber-50 border-3 p-5 rounded-3xl ">
            Реєстрація
          </button>
        </div> 
        */}
